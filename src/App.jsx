    ...
    <div style={{ minHeight: "100vh", background: "#0a0804", color: "#c8b89a", fontFamily: "'Cinzel', serif", position: "relative", overflow: "hidden" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        .menu-btn {
          ...
          width: 100%;
          max-width: 340px;
          background: linear-gradient(180deg, #2a1808 0%, #1a1005 100%);
          color: #c8b89a;
        ...
        .menu-btn:hover {
          border-color: #c09040;
          color: #f0d890;
          background: linear-gradient(180deg, #3a2510 0%, #2a1808 100%);
        }
        .menu-btn::before {
          content: '✦';
          color: #5a3e1b;
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "60px 24px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <div style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: 32, color: "#c09040", letterSpacing: 8, marginBottom: 8 }}>
            DARK HERESY
          </div>
          <div style={{ fontFamily: "'IM Fell English', serif", fontSize: 15, color: "#6a5030", letterSpacing: 4, marginBottom: 4 }}>
            Acolyte Management System
          </div>
          <div style={{ fontSize: 10, color: "#2a1808", letterSpacing: 3, fontFamily: "Cinzel", marginTop: 12 }}>
            ✦ — INQUISITION USE ONLY — ✦
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <button className="menu-btn disabled" onClick={() => {}}>
            View Characters
            <span className="menu-btn-sub">Coming soon — saved Acolyte roster</span>
          </button>
